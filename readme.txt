...
= 1.0.1.7 = 
This upgrade improves compatibility with Wordpress 5.4.

= 1.0.1.6 = 
This upgrade includes the latest version of 'Advanced Custom Fields' and fixes replaces some missing files.

= 1.0.1.5 = 
This upgrade includes the latest version of 'Advanced Custom Fields' and requires a database upgrade to complete. A website backup is recommended.
